	...
	var Oe = a[m]("header"),
		...
		st = function(e) {
			  ...
			  src = src
				  ...
				  .replace(/^(https?:)?\/\/[1-4]\.bp\.blogspot\.com\//, location.origin + "/cdn/image/");
			  ...
			  // Jika ada ratio → pakai w-h-c, kalau tidak → sNN
